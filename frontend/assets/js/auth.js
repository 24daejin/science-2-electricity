...
function homeUrl() {
  ...
  const subfolders = ['diagnostic', 'formative', 'chatbot', 'roster', 'dashboard', 'parent', 'eval-review', 'activity', 'my-dashboard'];
 ...
 * parent/, eval-review/, my-dashboard/)의 페이지에서 호출합니다. 로그인되어 있지 않으면
 * 루트 로그인 화면으로 돌려보냅니다.
 */
